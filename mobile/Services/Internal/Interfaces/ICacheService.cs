namespace mobile.Services.Internal.Interfaces
{
    ...
    public interface ICacheService
    {
        ...
        /// </summary>
        Task<List<WeatherForecast>> GetCachedForecastsAsync();

        /// <summary>
        /// Récupère une prévision du cache par son ID
        /// </summary>
        Task<WeatherForecast?> GetCachedForecastByIdAsync(int id);
        ...
        /// </summary>
        Task<List<SavedUserProfile>> GetCachedProfilesAsync();
