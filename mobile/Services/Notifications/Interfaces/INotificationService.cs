namespace mobile.Services.Notifications.Interfaces
{
    /// <summary>
    ...
    public interface INotificationService
    {
        ...
        /// </summary>
        Task ShowForecastCreatedAsync (WeatherForecast forecast);

        /// <summary>
        /// Affiche une notification pour un forecast mis à jour
        /// </summary>
        Task ShowForecastUpdatedAsync (WeatherForecast forecast);
